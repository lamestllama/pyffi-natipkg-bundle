...
(define deps '("base"))
(define pkg-desc
  "Relocatable CPython 3.12 (libpython + standard library) for aarch64 Linux (glibc) — used by pyffi-lib as its bundled Python when no system install is configured.")
