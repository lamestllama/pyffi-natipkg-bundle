...
(define deps '("base"))
(define pkg-desc
  "Relocatable CPython 3.12 (libpython + standard library) for x86_64 macOS (Intel) — used by pyffi-lib as its bundled Python when no system install is configured.")
