...
(define deps '("base"))
(define pkg-desc
  "Relocatable CPython 3.12 (libpython + standard library) for aarch64 macOS (Apple Silicon) — used by pyffi-lib as its bundled Python when no system install is configured.")
